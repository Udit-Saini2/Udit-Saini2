...
Deen Bandhu Sir Chotu Ram Government Polytechnic, Sampla, Haryana
...
Worked on practical web development tasks, not academic exercises
Gained hands-on experience in:
HTML & CSS-based frontend development
UI structure and layout implementation
Understanding professional development workflow
...
Data import/export using CSV and JSON
Interactive visualizations using Plotly
Expense trend analysis using Linear Regression
